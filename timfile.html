                ...
                <div class="row belowuserbar">
                    <div class="col-3 menubar">
                        <div class="row menu-item">
                            <a class="" href="index.html" data-tooltip="true" data-placement="right" title="Trang chủ"><i
                    ...
                    <div class="col-9 listfriendbar">
                        ...
                        <div class="row yourfriend friend-active">
                            <div class="col-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <input type="file" class="form-control-file inputfile" id="inputfile">
